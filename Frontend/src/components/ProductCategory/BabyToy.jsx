  ...
  useEffect(() => {
    const getProducts = async () => {
      try {
        ...
        // Filter products to only include those with category "Baby's Toy"
        const babyToyProducts = data.filter(product => product.category === "Baby's Toy");
    ...
    <div className='flex justify-center pb-36'>
      <div className='md:w-6xl xl:w-7xl max-w-7xl'>
        ...
        <div className='flex flex-col gap-3 mt-28'>
          ...
          <div className='text-size-2 font-2'>Explore Our Baby's Toy Products</div>
        </div>
